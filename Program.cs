...
namespace linq
{
    ...
    public class MillionairesBankHere
    {
        public string BankName { get; set; }
        public double MillionaireBalance { get; set; }
    }
    class Program
    {
    ...
    CITI 1
*/
            List<MillionairesBankHere> millionairesPerBank = (from customer in customers group customer by customer.Bank into millionairesBank select new MillionairesBankHere
            {
                BankName = millionairesBank.Key,
                    MillionaireBalance = millionairesBank.Count()
            }).ToList();

            Console.WriteLine("Bank Name and how many millionaires bank there:");
            millionairesPerBank.ForEach(millionaire => Console.WriteLine($"{millionaire.BankName} {millionaire.MillionaireBalance}"));
